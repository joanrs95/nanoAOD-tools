...
class jetmetUncertaintiesProducer(Module):
    def __init__(self, era, globalTag, jesUncertainties = [ "Total" ], jetType = "AK4PFchs", redoJEC=False, noGroom=False):
        ...
        #--------------------------------------------------------------------------------------------
        # We use this module only to MC sammples because we have gen variables
...
jetmetUncertainties5TeVMC = lambda : jetmetUncertaintiesProducer("2017", "Spring18_ppRef5TeV_V4_MC", [ "Total" ])
jetmetUncertainties5TeVAllMC = lambda : jetmetUncertaintiesProducer("2017", "Spring18_ppRef5TeV_V4_MC", [ "All" ])
